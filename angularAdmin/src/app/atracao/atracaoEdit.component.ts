...
@Component({
	selector: 'app-admin',
	templateUrl: './atracaoEdit.component.html'
	//styleUrls: ['./app.component.css']
})

export class AtracaoEditComponent extends GenericComponent implements OnInit {		

	constructor(private helper: Helper, private elemService: AtracaoService, private route: ActivatedRoute, fb: FormBuilder, private us: UploadService) {
		super(fb);
		this.compModule = this.environment.module_atracao;
		this.complexForm = fb.group(elemService.getFormValidator());
		helper.setPageInfo('Edição Atração', this.environment.module_atracao);
	}
