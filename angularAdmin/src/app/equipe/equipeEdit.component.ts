...
@Component({
	selector: 'app-admin',
	templateUrl: './equipeEdit.component.html'
	//styleUrls: ['./app.component.css']
})

export class EquipeEditComponent extends GenericComponent implements OnInit {		

	constructor(private helper: Helper, private elemService: EquipeService, private route: ActivatedRoute, fb: FormBuilder, private us: UploadService) {
		super(fb);
		this.compModule = this.environment.module_equipe;
		this.complexForm = fb.group(elemService.getFormValidator());
		helper.setPageInfo('Edição Equipe', this.environment.module_equipe);
	}
